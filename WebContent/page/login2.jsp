...
<div class="title">
    <h1>CRM系统</h1>
    <br />
    <b style="color:#ffffff">账号</b><input id="account" name="us_name" type="text"/><br><br>
    <b style="color:#ffffff">密码</b><input id="password" name="us_pwd" type="password"/><br>
    <label id="errorMessage" style="color:#ffffff;position:relative;left:23px;"></label>><br>
    <button id="btn" type="button" onclick="adminCheck()" style="color:#ffffff;background-color: #000000;width:85px;height:30px;position: relative;left:15px;">登录</button>
</div>
