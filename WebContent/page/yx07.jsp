...
<body> 
	<div id="right" class="size">
		<ol class="breadcrumb" id="breadcrumb">
			...
			<li style="color: #269ABC;"><span>编辑销售机会</span></li>
			<li><span>${msg }</span></li>
		</ol>
		
		<form action="/crm/dgp_YxUpdateServlet.do?xs_no=${row.xs_no}" method="post">
			<table id="table01" class="table table-bordered">
				<tr>
					<td align="center" id="label01">客户名称</td>
					<td><input class="form-control importantInput"  name="xs03" value="${row.xs03}"/><span class="importantTag">*</span></td>
					...
					<td><input class="form-control" name="xs02" value="${row.xs02}"/></td>
				</tr>
				<tr>
					<td align="center" id="label01">概要</td>
					<td colspan="3"><input class="form-control"  name="xs05" value="${row.xs05}" style="display: inline-block;width: 99%;"><span class="importantTag">*</span></td>
				</tr>
				<tr>
					<td align="center" id="label01">联系人</td>
					<td><input class="form-control"  name="xs06" value="${row.xs06}"/></td>
					<td align="center" id="label01">联系电话</td>
					<td><input class="form-control"  name="xs07"  value="${row.xs07}"/></td>
				</tr>
				<tr>
					<td align="center" id="label01">机会描述</td>
					<td colspan="3">
						<textarea class="form-control"  name="xs08" style="display: inline-block;width: 98%;" rows="5">${row.xs08}</textarea>
				...
				<tr>
					...
					<td><input class="form-control" readonly="readonly"  value="${row.xs10 }"/></td>
				</tr>
				<tr>
					<td align="center" id="label01">成功几率</td>
					<td><input class="form-control"  name="xs04" value="${row.xs04}"/></td>
					<td colspan="4">
						<div>
							<a href="javascript:history.back()"><button type="button" class="btn btn-default" style="margin-left: 75%;">返回</button></a>
							<button onclick="tijiao('p2')" id="submitButton" type="submit" class="btn btn-primary"/>编辑</button>
							<p id="p2" style="display: none;">请完善信息</p>
						</div>
					</td>
				</tr>
			</table>
			<input type="hidden" id="hidden" value="${row.no}"> 
		</form>
	</div>
</body>
...
<script type="text/javascript">
	...
	///crm/dgp_FpSelectServlet.do?xs_no=${ibm.xs_no }
