...
<body>
	...
	<div id="right" class="size">
		<ol class="breadcrumb" id="breadcrumb">
			...
			<li style="color: #269ABC;"><span>服务归档查看</span></li>
		</ol>
		...
		<form action="" method="post">
			<table id="table01" class="table table-bordered">
				<tr>
					...
					<td class="col-md-5">${row.fw_no}</td>
				...
				<tr>
					...
					<td class="col-md-7">${row.fwcljg }</td>
					<td class="col-md-1" style="vertical-align: middle;">满意度</td>
					<td class="col-md-3">${row.px }</td>
				</tr>
				<tr>
					<td colspan="4">
						<input type="button" class="btn btn-primary btn-sm" 
						style="float: right;" value="返回" onclick="break1()"/>
					</td>
				</tr>
			</table>
		</form>
